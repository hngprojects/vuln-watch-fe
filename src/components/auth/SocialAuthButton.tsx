  ...
  return (
    <div className="relative w-full">
      <button
        ...
        disabled={isLoading}
        className="flex w-full items-center justify-center gap-2 rounded-md border border-[#EFEFEF] bg-white px-4 py-2.5 text-sm font-medium text-[#2B2B2B] transition hover:bg-[#FAFAFA] disabled:cursor-not-allowed disabled:opacity-60"
      >
        <GoogleIcon />

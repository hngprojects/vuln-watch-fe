      ...
      <div className="mx-auto max-w-7xl px-5 md:px-10">
        <div className="flex flex-col items-center lg:flex-row">
          <div className="w-full text-center sm:text-left lg:w-1/2">
            <h1 className="mb-2 text-4xl leading-snug font-bold lg:mr-20 lg:text-[50px] lg:leading-tight">
            ...
            <p className="text-foreground mt-5 mb-8 text-lg md:mt-7 md:mb-12 md:text-xl">
            ...
            <Link
              href="/register"
              className="bg-primary text-background hover:bg-destructive rounded px-8 py-4"
          ...
          <div className="mt-14 flex w-full justify-end rounded-lg lg:mt-0 lg:w-1/2">
            <div className="bg-subtle relative w-full rounded-lg sm:w-[90%] md:h-[300px] md:w-[95%] lg:h-[526px] lg:w-[418px]">
              ...
              <div
                ...
                className="absolute right-8 bottom-[-1.25rem] z-20"
              >
                <HeroChat />
              </div>

...
const FAQs = () => {
  return (
    <section className="wrapper bg-[#fafafa] py-[96px]">
      <div className="grid items-center gap-16 rounded-2xl bg-[#f4f4f5] p-8 sm:p-10 md:grid-cols-[min-content_1fr] md:rounded-4xl md:p-14">
